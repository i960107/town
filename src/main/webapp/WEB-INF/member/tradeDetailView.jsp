...
<body>
	<table style="height: 310px;" align="center">
		<tr>
			<td>
				<div class="box">
					<img alt="" src="<%=source%>/resources/members/${mBean.image}"
						class="profile">
				</div>
			</td>
			<td>
				<table style="width: 710px;">
					<tr>
						<td>
							<!-- 판매자 아이디 --> <span>${mBean.id }</span>
						</td>
					</tr>
					<tr>
						<td>
							<!-- 판매자 주소 --> <span>${mBean.address }</span>
						</td>
					</tr>
					<tr>
						<td>
							<!-- 판매상품 갯수 --> <span>판매상품 : ${fn:length(pList) }</span>
						</td>
					</tr>
					<tr>
						<td>
							<!-- 매너 평가 이동 --> <span class="active" style="clear: none;"><a
								href="tradeReview.mb">매너평가하기</a></span>
						</td>
					</tr>
					<tr>
						<td>
							<!-- 매너온도계 --> <img alt=""
							src="<%=source%>/resources/img/temp_bar.png" class="temp-img"
							width="200" height="30"> <c:if test="${mtemp<=49.9 }">
								<img alt="" src="<%=source%>/resources/img/temp_orange.png"
									class="temp-img" width="${mtemp*2 }" height="30">
							</c:if> <c:if test="${mtemp>=50 }">
								<img alt="" src="<%=source%>/resources/img/temp_red.png"
									class="temp-img" width="${mtemp*2 }" height="30">
							</c:if> <span class="temp">&nbsp;&nbsp; ${mtemp }℃</span>
						</td>
					</tr>
				</table>
			</td>
	...
	<table align="center" style="width: 720px;">
		<tr>
			<td colspan="4"><span onclick="callPlist()" class="list-table">상품
