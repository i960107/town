						...
						<form action="" name="categoryform">
							...
							<table>
								...
								<tr>
									...
									<input class="btn btn-warning" style="font-weight: bold;"
				...
				<c:forEach var="i" items="${searchList}">
					...
					<div class="flex-container-product-item">
						...
						<div>
							...
							</a> <br> <span class="id">${i.sellerid } </span>&nbsp&nbsp&nbsp&nbsp&nbsp<span
								class="regdate"><i class="fa fa-calendar-o"></i>
							<script>
								document
										.write(displayTime('<c:out value="${i.regdate}"/>'));
							</script> &#128065;${i.readcount}</span> <br> <span class="subject">${i.subject}</span> <br>
							<span class="price">${i.price } 원</span> <br> ${i.address1 }
							${i.address2 }<br> 
						</div>
						<div>
