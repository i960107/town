			...
			<td>
				<table>
					...
					<tr height="72">
						...
						<fmt:formatNumber pattern="###,###">${pBean.price }</fmt:formatNumber> 원
						</span> <br>
							<hr></td>
					</tr>
					<tr height="72">
						...
						<td width="120"><a href="report.prd"><span class="mcontent">신고하기</span></a>
								</td>
					</tr>
					<tr height="72">
						<td colspan="3" valign="top"><span class="mcontent">거래지역</span>
						<span style="font-size: 15px; font-weight: bold; color: #A0A0A0;">: ${pBean.address }</span></td>
					</tr>
					<tr height="72">

						<!------------- 좋아요 싫어요 하트 색 / 유동 함수 -------------->
						<td><c:set var="loginId"><%=loginId%></c:set> <c:set
								var="heart" value="&#10084;" /> <c:set var="likecondition" value="prdLike()" /> 
							...
							<input type="button" name="like" value="${heart } 찜 ${likeCnt}"
