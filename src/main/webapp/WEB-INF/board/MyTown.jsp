						...
						<div class="group-input">
							...
							<c:forEach var="mbrlist" items="${mbrlists }">
									<tr align="center">
										...
										<td class="group-input"><label>${mbrlist.ref }
										</label></td>
										<td class="group-input"><label>${mbrlist.contents }
										</label></td>
										<td class="group-input"><label> <fmt:parseDate
													value="${mbrlist.regDate } " var="regdate"
													pattern="yyyy-MM-dd" /> <fmt:formatDate value="${regdate }"
													pattern="yyyy-MM-dd" />
										</label></th>
										<td class="group-input"><label><a href="delete.bd?no=${mbrlist.no }">삭제</a></label></td>
									</tr>
								</c:forEach>
						</div>
					</table>
